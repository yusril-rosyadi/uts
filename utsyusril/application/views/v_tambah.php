...
<head>
  ...
  <title>mahasiswa | Data Tables</title>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Muhammad Yusril</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <!-- <li><a href="<?php echo base_url('c_mahasiswa/modal');?>"><i class="fa fa-circle-o"></i> </a></li>
            <li><a href="<?php echo base_url('c_mahasiswa/rekap');?>"><i class="fa fa-circle-o"></i> </a></li> -->
          </ul>
        </li>
      </ul>
    </section>
			...
			<div class="modal-body">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input name="jenis_kelamin" class="form-control" type="text" maxlength="10" placeholder="laki-laki , perempuan" required >
                        </div>
                    </div>
                    <div class="form-group">
